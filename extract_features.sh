...
python3 extract_features.py \
  --source 'C:/Users/SEBASTIAN/OneDrive/Documents/ALU/SS2026/DL lab/project/RL3/datasets/KITTI-360-low/data_2d_raw/2013_05_28_drive_0000_sync/image_00/data_rect' \
  --weights yolov5s.pt \
  --conf 0.25  \
  --save-txt \
  --save-conf \
  --name 'data_2d_raw/2013_05_28_drive_0000_sync/image_00/data_rect' \
